...
def split_story_script(script_text: str):
    ...
    if not api_key:
        ...
        logger.info("   Để dùng tính năng Auto-Split (AI Cắt Truyện), hãy làm theo 2 bước sau:")
        logger.info("   1. Lấy mã miễn phí tại: https://aistudio.google.com/app/apikey")
        logger.info("   2. Tạo một file tên là `.env` cùng thư mục code, ghi nội dung:")
        logger.info("      GEMINI_API_KEY=mã_của_bạn_ở_đây")
        return None
